...
public class ClientEI extends Client {
	...
	public ClientEI(TitrePhysique titre, String prenom, Long id, String nom, Integer numTel, Integer numFax, String email, Adresse adresse, Set<Reservations> reservations) {
		super();
		this.titre = titre;
		this.prenom = prenom;
	}
