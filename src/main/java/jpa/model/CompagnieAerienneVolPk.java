...
public class CompagnieAerienneVolPk implements Serializable{
	@ManyToOne
	@JoinColumn(name = "id_vol_compagnie_aerienne_vol", foreignKey =@ForeignKey(name = "compagnie_aerienne_vol_id_fk"))
	private Vol vol;
	@ManyToOne
	@JoinColumn(name = "id_compagnie_aerienne_compagnie_aerienne_vol", foreignKey =@ForeignKey(name = "id_compagnie_aerienne_compagnie_aerienne_vol_fk"))
